...
Elm.Phonecat = Elm.Phonecat || {};
Elm.Phonecat.make = function (_elm) {
   "use strict";
   _elm.Phonecat = _elm.Phonecat || {};
   if (_elm.Phonecat.values)
   return _elm.Phonecat.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   ...
   $String = Elm.String.make(_elm),
   $Text = Elm.Text.make(_elm);
   var listItem = function (p) {
      return A2($Graphics$Element.flow,
      $Graphics$Element.down,
      _L.fromArray([$Text.plainText(" ")
                   ,A2($Graphics$Element.flow,
                   $Graphics$Element.right,
                   _L.fromArray([$Graphics$Element.link(A2($Basics._op["++"],
                                "#/phones/",
                                p.id))(A3($Graphics$Element.image,
                                100,
                                100,
                                p.imageUrl))
                                ,A2($Graphics$Element.flow,
                                ...
                                _L.fromArray([$Graphics$Element.link(A2($Basics._op["++"],
                                             "#/phones/",
                                             p.id))($Text.leftAligned($Text.bold($Text.fromString(p.name))))
                                             ,$Text.plainText(p.snippet)]))]))
                   ,$Text.plainText(" ")]));
   };
   var phoneContainsText = F2(function (s,
   p) {
      return A2($String.contains,
      s,
      p.name) || A2($String.contains,
      s,
      p.snippet);
   });
   var phoneScene = function (id) {
      return $Text.plainText(A2($Basics._op["++"],
      "TBD: detail view for ",
      id));
   };
   var orderOptions = _L.fromArray([{ctor: "_Tuple2"
                                    ,_0: "Alphabetical"
                                    ,_1: $List.sortBy(function (_) {
                                       return _.age;
                                    })}
                                   ,{ctor: "_Tuple2"
                                    ,_0: "Newest"
   ...
   var order = $Signal.channel($Basics.identity);
   var query = $Signal.channel($Graphics$Input$Field.noContent);
   var indexElements = F3(function (q,
   sortPhones,
   phones) {
      return A2($Graphics$Element.flow,
      $Graphics$Element.right,
      _L.fromArray([A2($Graphics$Element.flow,
                   $Graphics$Element.down,
                   _L.fromArray([$Text.plainText("Search:")
                                ...
                                $Signal.send(order),
                                orderOptions)]))
                   ,$Graphics$Element.flow($Graphics$Element.down)($List.map(listItem)($List.reverse(sortPhones(A2($List.filter,
                   phoneContainsText(q.string),
                   phones)))))]));
   });
   var indexScene = F3(function (q,
   sortPhones,
   phonesResp) {
      return function () {
         switch (phonesResp.ctor)
         {case "Failure":
            return $Text.plainText(A2($Basics._op["++"],
              "failed with ",
              A2($Basics._op["++"],
              $Basics.toString(phonesResp._0),
              A2($Basics._op["++"],
              " ",
              phonesResp._1))));
            case "Success":
            return function () {
                 switch (phonesResp._0.ctor)
                 {case "Err":
                    return $Text.plainText(phonesResp._0._0);
                    case "Ok":
                    return A3(indexElements,
                      q,
                      sortPhones,
                      phonesResp._0._0);}
                 _U.badCase($moduleName,
         ...
         _U.badCase($moduleName,
         "between lines 98 and 108");
      }();
   });
   var location = _P.portIn("location",
   _P.incomingSignal(function (v) {
      return typeof v === "object" && "hash" in v && "host" in v && "hostname" in v && "href" in v && "pathname" in v && "port_" in v && "protocol" in v && "search" in v ? {_: {}
                                                                                                                                                                            ,hash: typeof v.hash === "string" || typeof v.hash === "object" && v.hash instanceof String ? v.hash : _U.badPort("a string",
                                                                                                                                                                            v.hash)
                                                                                                                                                                            ,host: typeof v.host === "string" || typeof v.host === "object" && v.host instanceof String ? v.host : _U.badPort("a string",
                                                                                                                                                                            v.host)
                                                                                                                                                                            ,hostname: typeof v.hostname === "string" || typeof v.hostname === "object" && v.hostname instanceof String ? v.hostname : _U.badPort("a string",
                                                                                                                                                                            v.hostname)
                                                                                                                                                                            ,href: typeof v.href === "string" || typeof v.href === "object" && v.href instanceof String ? v.href : _U.badPort("a string",
                                                                                                                                                                            v.href)
                                                                                                                                                                            ,pathname: typeof v.pathname === "string" || typeof v.pathname === "object" && v.pathname instanceof String ? v.pathname : _U.badPort("a string",
                                                                                                                                                                            v.pathname)
                                                                                                                                                                            ,port_: typeof v.port_ === "string" || typeof v.port_ === "object" && v.port_ instanceof String ? v.port_ : _U.badPort("a string",
                                                                                                                                                                            v.port_)
                                                                                                                                                                            ,protocol: typeof v.protocol === "string" || typeof v.protocol === "object" && v.protocol instanceof String ? v.protocol : _U.badPort("a string",
                                                                                                                                                                            v.protocol)
                                                                                                                                                                            ,search: typeof v.search === "string" || typeof v.search === "object" && v.search instanceof String ? v.search : _U.badPort("a string",
                                                                                                                                                                            v.search)} : _U.badPort("an object with fields \'hash\', \'host\', \'hostname\', \'href\', \'pathname\', \'port_\', \'protocol\', \'search\'",
      v);
   }));
   var Location = F8(function (a,
   b,
   c,
   d,
   e,
   ...
   var phoneDecoder = A6($Json$Decode.object5,
   Phone,
   A2($Json$Decode._op[":="],
   "age",
   $Json$Decode.$float),
      ...
      return function () {
         ...
         {case "Failure":
            return A2($Http.Failure,
              ...
              r._1);
            case "Success":
            return $Http.Success(A2($Json$Decode.decodeString,
              $Json$Decode.list(phoneDecoder),
              r._0));
            case "Waiting":
            return $Http.Waiting;}
         _U.badCase($moduleName,
   ...
   var main = function () {
      var maybePhoneScene = function (l) {
         return function () {
            var _v11 = A3($Regex.find,
            $Regex.AtMost(1),
            $Regex.regex("^#/phones/([^/]+)$"),
            l.hash);
            switch (_v11.ctor)
                         ...
                         {case "::":
                            switch (_v14._0.ctor)
                              {case "Just":
                                 switch (_v14._1.ctor)
                                   {case "[]":
                                      return $Maybe.Just(phoneScene(_v14._0._0));}
                                   break;}
                              break;}
                         return $Maybe.Nothing;
                      }();}
   ...
   _elm.Phonecat.values = {_op: _op
                          ,Phone: Phone
                          ,Location: Location
                          ,phoneDecoder: phoneDecoder
                          ,phonesApi: phonesApi
                          ,query: query
                          ,order: order
                          ...
                          ,phoneContainsText: phoneContainsText
                          ,listItem: listItem};
   return _elm.Phonecat.values;
};
Elm.Regex = Elm.Regex || {};
